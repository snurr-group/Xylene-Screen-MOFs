...
REAL CalculateFrameworkVDWEnergyAtPosition(POINT posA,int typeA,REAL scaling)
{
  ...
  {
    if((Framework[CurrentSystem].FrameworkModel==GRID)&&(VDWGrid[typeA])&&(PseudoAtoms[typeA].GridAccurate))   // grid-interpolating for rigid frameworks
    {
...
// beginning of added function
// not going to test with grid accuracy: since we are going to use fake bead's grid anyway
REAL CalculateFrameworkVDWEnergyAtPositionEBFakeFirstBead(POINT posA,int typeA,REAL scaling)
{
  int i,j,typeB,f1;
  REAL rr;
  REAL UVDW;
  ...
  fprintf(stderr, "Looped over, UVDW is %lf\n", UVDW);
  return UVDW;
...
void CalculateFrameworkChargeEnergyAtPosition(POINT posA,int typeA,REAL *UChargeCharge,REAL *UchargeBondDipole,REAL scaling)
{
  ...
  if(Framework[CurrentSystem].FrameworkModel!=NONE)
  {
    if((Framework[CurrentSystem].FrameworkModel==GRID)&&(CoulombGrid)&&(PseudoAtoms[typeA].GridAccurate))
    {
...
int CalculateFrameworkAdsorbateVDWEnergy(void)
{
  ...
  for(i=0;i<NumberOfAdsorbateMolecules[CurrentSystem];i++)
  {
    ...
    for(j=0;j<Adsorbates[CurrentSystem][i].NumberOfAtoms;j++)
    {
      ...
      if((Framework[CurrentSystem].FrameworkModel==GRID)&&(VDWGrid[typeA])&&(!IsFractionalAdsorbateMolecule(i))&&(PseudoAtoms[typeA].GridAccurate))
      {
...
int CalculateFrameworkCationVDWEnergy(void)
{
  ...
  for(i=0;i<NumberOfCationMolecules[CurrentSystem];i++)
  {
    ...
    for(j=0;j<Cations[CurrentSystem][i].NumberOfAtoms;j++)
    {
      ...
      if((Framework[CurrentSystem].FrameworkModel==GRID)&&(VDWGrid[typeA])&&(!IsFractionalCationMolecule(i))&&(PseudoAtoms[typeA].GridAccurate))
      {
...
int CalculateFrameworkAdsorbateChargeChargeEnergy(void)
{
  ...
  for(i=0;i<NumberOfAdsorbateMolecules[CurrentSystem];i++)
  {
    ...
    for(j=0;j<Adsorbates[CurrentSystem][i].NumberOfAtoms;j++)
    {
      ...
      if((Framework[CurrentSystem].FrameworkModel==GRID)&&(CoulombGrid)&&(!IsFractionalAdsorbateMolecule(i))&&(PseudoAtoms[typeA].GridAccurate))
      {
...
int CalculateFrameworkCationChargeChargeEnergy(void)
{
  ...
  for(i=0;i<NumberOfCationMolecules[CurrentSystem];i++)
  {
    ...
    for(j=0;j<Cations[CurrentSystem][i].NumberOfAtoms;j++)
    {
      ...
      if((Framework[CurrentSystem].FrameworkModel==GRID)&&(CoulombGrid)&&(!IsFractionalCationMolecule(i))&&(PseudoAtoms[typeA].GridAccurate))
      {
...
int CalculateFrameworkAdsorbateReplicaVDWEnergy(void)
{
  ...
  for(i=0;i<NumberOfAdsorbateMolecules[CurrentSystem];i++)
  {
    ...
    for(j=0;j<Adsorbates[CurrentSystem][i].NumberOfAtoms;j++)
    {
      ...
      if((Framework[CurrentSystem].FrameworkModel==GRID)&&(VDWGrid[typeA])&&(PseudoAtoms[typeA].GridAccurate))
      {
        UHostAdsorbateVDW[CurrentSystem]+=InterpolateVDWGrid(typeA,posA);
      }
      else
  ...
  if(New)
  {
    if(Framework[CurrentSystem].FrameworkModel!=NONE)
    {
      ...
      for(j=0;j<nr_atoms;j++)
      {
        ...
        if((Framework[CurrentSystem].FrameworkModel==GRID)&&(VDWGrid[typeA])&&CanUseGridNew&&(PseudoAtoms[typeA].GridAccurate))
  ...
  if(Old)
  {
    if(Framework[CurrentSystem].FrameworkModel!=NONE)
    {
      ...
      for(j=0;j<nr_atoms;j++)
      {
        ...
        if((Framework[CurrentSystem].FrameworkModel==GRID)&&(VDWGrid[typeA])&&CanUseGridOld&&(PseudoAtoms[typeA].GridAccurate))
  ...
  if(New)
  {
    if(Framework[CurrentSystem].FrameworkModel!=NONE)
    {
      ...
      for(j=0;j<Components[comp].NumberOfAtoms;j++)
      {
        ...
        if((ChargeMethod!=NONE)&&(Framework[CurrentSystem].FrameworkModel==GRID)&&(CoulombGrid)&&CanUseGridNew&&(PseudoAtoms[typeA].GridAccurate))
  ...
  if(Old)
  {
    if(Framework[CurrentSystem].FrameworkModel!=NONE)
    {
      ...
      for(j=0;j<Components[comp].NumberOfAtoms;j++)
      {
        ...
        if((ChargeMethod!=NONE)&&(Framework[CurrentSystem].FrameworkModel==GRID)&&(CoulombGrid)&&CanUseGridOld&&(PseudoAtoms[typeA].GridAccurate))
